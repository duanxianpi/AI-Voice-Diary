...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/Cowboy hat face.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/Neutral face.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/Dissapointed face.svg", QSize(), QIcon.Normal, QIcon.Off)
